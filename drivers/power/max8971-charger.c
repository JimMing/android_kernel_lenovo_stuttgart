...
int max8971_check_charger_details(void){
	...
	if((value != old_value)&&(old_value == 5)){
		printk("wz, restart charge\n");
		max8971_set_bits(max8971_chg->client, MAX8971_REG_CHGCNTL1, MAX8971_USB_SUS_MASK, 1);//disable charger
		max8971_set_bits(max8971_chg->client, MAX8971_REG_CHGCNTL1, MAX8971_USB_SUS_MASK, 0);//enable charger
	}
	old_value = value;
...
int max8971_dump_regs(void){
	if(!max8971_chg)
		return 0xff;
	dev_err(&max8971_chg->client->dev,"dump registers:\n");
	dev_err(&max8971_chg->client->dev,"CHG_STAT(%x)\n",max8971_read_reg(max8971_chg->client, 0x02));
	dev_err(&max8971_chg->client->dev,"DETAILS1(%x)\n",max8971_read_reg(max8971_chg->client, 0x03));
	dev_err(&max8971_chg->client->dev,"DETAILS2(%x)\n",max8971_read_reg(max8971_chg->client, 0x04));
	dev_err(&max8971_chg->client->dev,"CHGCNTL1(%x)\n",max8971_read_reg(max8971_chg->client, 0x05));
	return 0;
}
